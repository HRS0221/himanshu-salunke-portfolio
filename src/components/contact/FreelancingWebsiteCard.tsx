...
const FreelancingWebsiteCard: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Card Content */}
      <div className="bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 rounded-xl p-8 text-center">
        <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="text-center">
            ...
            <div className="text-sm font-semibold text-neutral-900 dark:text-white">AI/ML & LLM</div>
            <div className="text-xs text-neutral-600 dark:text-neutral-400">Complete ML Pipelines</div>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2">💻</div>
            <div className="text-sm font-semibold text-neutral-900 dark:text-white">Web & Mobile</div>
            <div className="text-xs text-neutral-600 dark:text-neutral-400">Full-Stack Applications</div>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2">⚡</div>
            <div className="text-sm font-semibold text-neutral-900 dark:text-white">Fast Delivery</div>
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-semibold rounded-lg hover:from-primary-600 hover:to-secondary-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
