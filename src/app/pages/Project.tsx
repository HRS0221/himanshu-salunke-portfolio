    ...
    <ErrorBoundary>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-neutral-50 to-white dark:from-neutral-900 dark:to-neutral-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-neutral-900 dark:text-white mb-8 leading-tight">
                {project.title}
              </h1>
              <p className="text-xl md:text-2xl text-neutral-600 dark:text-neutral-400 max-w-4xl mx-auto mb-12 leading-relaxed">
                {project.summary}
              </p>
        ...
        <section className="pt-2 pb-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 xl:mr-80">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="flex-1">
                {navigationLoading ? (
                  <div className="p-6 bg-white dark:bg-neutral-800 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <div className="animate-pulse flex items-center gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="h-5 bg-neutral-200 dark:bg-neutral-700 rounded w-32 mb-1"></div>
                  ...
                  <Link
                    ...
                    className="group flex items-center gap-6 p-6 bg-white dark:bg-neutral-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-neutral-200 dark:border-neutral-700 hover:border-primary-200 dark:hover:border-primary-800"
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">Previous Project</p>
                      <p className="font-bold text-lg text-neutral-900 dark:text-white group-hover:text-primary-500 transition-colors">
                  ...
                  <div className="p-4 opacity-50">
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">No previous project</p>
                  </div>
                )}
              </div>
              ...
              <div className="flex-shrink-0">
                <Link to="/work">
                  <Button 
                    variant="primary" 
                    className="flex items-center gap-3 px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                ...
                {navigationLoading ? (
                  <div className="p-6 bg-white dark:bg-neutral-800 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700">
                    <div className="animate-pulse flex items-center gap-6">
                      <div className="flex-1 text-right">
                        <div className="h-4 bg-neutral-200 dark:bg-neutral-700 rounded w-20 mb-2 ml-auto"></div>
                        <div className="h-5 bg-neutral-200 dark:bg-neutral-700 rounded w-32 mb-1 ml-auto"></div>
                        <div className="h-3 bg-neutral-200 dark:bg-neutral-700 rounded w-24 ml-auto"></div>
                      </div>
                      <div className="w-12 h-12 bg-neutral-200 dark:bg-neutral-700 rounded-xl"></div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="text-right flex-1">
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">Next Project</p>
                      <p className="font-bold text-lg text-neutral-900 dark:text-white group-hover:text-primary-500 transition-colors">
                  ...
                  <div className="p-6 opacity-50 text-right">
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">No next project</p>
                  </div>
                )}
              </div>
            </motion.div>
